...
const FAQS = [
  ...
  },
  {
    ...
    a: "Most conversions run entirely in your browser via WebAssembly — those files never leave your device. Only legacy binary formats (DOC and similar) require a full layout engine and are sent to an optional self-hosted helper running LibreOffice — and only when such a helper is available. Every conversion path is labeled “100% local” or “server-assisted” before you convert.",
  },
  {
